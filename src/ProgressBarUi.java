...
public class ProgressBarUi extends BasicProgressBarUI {
    ...
    public ProgressBarUi() {
        try {
            bimage = ImageIO.read(this.getClass().getResource("/rainbow.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        Icons.BARNEY_DANCING.paintIcon(progressBar, g, offset2 - JBUIScale.scale(3), +JBUIScale.scale(-2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        g2.fill(new RoundRectangle2D.Float(2f * off, 2f * off, amountFull + JBUIScale.scale(3f), h - JBUIScale.scale(5f), JBUIScale.scale(7f), JBUIScale.scale(7f)));

        Icons.BARNEY.paintIcon(progressBar, g2, amountFull - JBUIScale.scale(5), -JBUIScale.scale(1));
        g2.translate(0, -(c.getHeight() - h) / 2);
